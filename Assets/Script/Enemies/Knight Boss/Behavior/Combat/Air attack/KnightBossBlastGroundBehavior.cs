...
public class KnightBossBlastGroundBehavior : StateMachineBehaviour
{
    ...
    protected void LoadReferences(Animator animator)
    {
        ...
        this.blastAppearing_ParticleSystem = animator.transform.Find("Particle system").Find("GroundBlast_Appearing").GetComponent<ParticleSystem>();
        ...
        this.blast_ParticleSystem = animator.transform.Find("Particle system").Find("GroundBlast").GetComponent<ParticleSystem>();
        ...
        // blast gameObject
        this.blast_gameObject = animator.transform.Find("Combat").Find("Skills").Find("BlastGround").gameObject;
